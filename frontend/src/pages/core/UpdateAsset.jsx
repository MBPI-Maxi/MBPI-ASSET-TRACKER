...
//       const selectedAsset = assets.find(asset => asset.asset_id === selectedId);
//       if (selectedAsset) {
//         // Only update if form is different to prevent infinite loop
//         setForm(prevForm => {
//           const newForm = {
//             item_name: selectedAsset.item_name || '',
//             department: selectedAsset.department || '',
...
//           // Simple shallow compare (you can improve this)
//           const isSame = Object.keys(newForm).every(key => newForm[key] === prevForm[key]);
//           if (!isSame) {
//             return newForm;
//           }
//           return prevForm; // no change, no state update
//         });
//         setErrors({}); // This is probably fine
//       }
//     } else {
//       setForm({
//         item_name: '',
...
const UpdateAsset = () => {
  ...
  // This function is no longer needed since Autocomplete's onChange handles the logic directly.
  // const handleSelectChange = (e) => {
  //   const id = parseInt(e.target.value);
  //   setSelectedId(id);
